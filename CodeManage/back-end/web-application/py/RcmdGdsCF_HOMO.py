...
t_user = pd.read_csv(sys.argv[1]+"/py/anal_data/t_user.csv",dtype={
    "user_id":str
})
t_goods = pd.read_csv(sys.argv[1]+"/py/anal_data/t_goods.csv")
t_buy = pd.read_csv(sys.argv[1]+"/py/anal_data/t_buy.csv",dtype={
    "user_id":str
})
